...
error_value_length_must_between_1_or_40 = 'value length must be between customer_gw and 40 runes, inclusive'
...
error_value_length_must_be_at_least_1 = 'value length must be at least customer_gw runes'
